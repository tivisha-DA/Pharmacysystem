					...
					<div class="details">
						...
						<form method="POST">
							<div class="form-group form-box">
								<input type="email" name="email" class="form-control" placeholder="Email Address" aria-label="Email Address" value="{$email}" disabled>
							</div>
							<div class="form-group form-box">
							...
							<div class="form-group">
								<button type="submit" class="btn-md btn-theme w-100">Reset Your Password</button>
							</div>
